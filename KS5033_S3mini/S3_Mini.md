...
- **Expandable**: The expansion board exposes extra GPIO, I²C and other interfaces via 2.54 mm pin headers for connecting additional sensors and functional modules to the robot.
...
| :--- | :--- | :--- | :--- |
| Assembled chassis (no pre-wiring) | ESP32-S3-Mini Xiaozhi AI Chat Robot Pre-assembled Semi-finished Unit | Fix mainboard, easy wiring, complete assembly set for building Xiaozhi AI voice robot | ![](media/image-20260920083716888.png) |
...
| Dupont Wires                      | 5‑pin female‑to‑female, 100 mm                               | Inter‑module wiring between modules and mainboard            | ![Img](./media/19700349.png)           |

## Hardware Introduction

### 1. ESP32‑S3‑Mini Development Board
![Img](media/MB0183.png)
The KEYES ESP32‑S3‑Mini is a high‑performance development board built on Espressif ESP32‑S3‑WROOM‑1‑N16R8 module. It integrates 2.4 GHz Wi‑Fi and BLE, features a dual‑core Xtensa LX7 CPU up to 240 MHz, 16 MB Flash and 8 MB PSRAM, and supports hardware‑accelerated machine learning for efficient inference in AI scenarios such as speech recognition and image processing.

#### Main Features

- **High‑Performance Processing**
  - Dual‑core Xtensa® LX7 architecture with CPU frequency up to 240 MHz
  - Hardware‑accelerated machine learning to speed‑up inference for AI applications

- **Wireless Connectivity**
  - Integrated 2.4 GHz 802.11 b/g/n Wi‑Fi
  - Bluetooth 5.0 and Bluetooth Low Energy (BLE) for short‑range communication in multiple scenarios

- **Rich Interfaces**
  - Up to 38 GPIO pins
  - Built‑in communication peripherals: 12‑bit ADC, DAC, PWM, I2C, SPI, UART and more
  - On‑board LED indicator, BOOT and Reset function buttons

- **Security Features**
  - Hardware encryption engine (AES, SHA, RSA, etc.)
  - Supports Secure Boot and Flash Encryption for multi‑layer hardware‑to‑firmware security protection

- **Low‑Power Design**
  - Standby current as low as ~10 μA; Wi‑Fi operating power is also optimized
  - Suitable for battery‑powered or long‑runtime projects

- **Development Ecosystem**
  - Supports Arduino IDE for fast prototyping
  - Compatible with advanced frameworks such as ESP‑IDF and PlatformIO for custom projects

### 2. KEYES S3 AI Mini Sensor Shield Expansion Board

![Img](media/KS5035.png)

#### Introduction
The KEYES ESP32‑S3 AI Mini Sensor Shield is an expansion board specially designed for the S3‑Mini development board. Most IO ports of the S3‑Mini are broken‑out via 2.54 mm 3‑pin headers for easy connection to various peripheral modules. This expansion board also integrates MIC, speaker and screen interfaces tailored for peripherals of the XiaoZhi AI Chatbot.

#### Features
1. **Unified Interfaces**: All sensors, power amplifier and microphone modules connect neatly via pin headers.
2. **On‑board Power Management**: Accepts 6‑9 V battery input; MIC29302 steps voltage down to 5 V, then AMS1117 steps further down to 3.3 V to supply stable power for each module.
3. **Dedicated Interfaces**: Provides microphone, speaker and screen interfaces for plug‑and‑play operation.
4. **IO Expansion**: Exposes extra GPIO pins for adding more sensors.

#### Main Specifications

| Parameter              | Value / Range             | Remarks                                        |
|-------------------|-------------------------|---------------------------------------------|
| **Operating Voltage** | DC 6‑9 V | Input from battery holder or DC power adapter |
| **5 V Max Output Current** | 1.5 A | Powers peripherals such as display screen |
| **3.3 V Max Output Current** | 0.5 A | Powers sensor modules |
| **Header Pitch** | 2.54 mm | Standard spacing |
| **Operating Temperature** | -25 ℃ ~ +55 ℃ | Works for most common environments |
| **Dimensions** | 64 mm × 88 mm | Matches acrylic mounting plate |
...
#### Introduction
ICS‑43432 is a MEMS‑based digital microphone integrating pre‑amplifier, ADC and I²S output. Compared with traditional analog microphones, it effectively reduces cabling noise and is well‑suited for speech‑recognition and interactive‑audio projects.
...
5. **High Sensitivity**: Captures faint sound for speech‑recognition use‑cases.
...
#### Description
This module uses the NS4168 chip: a high‑efficiency, low‑noise, highly‑integrated Class‑D audio amplifier, especially suitable for battery‑powered portable audio devices with strict power‑consumption and anti‑interference requirements. Its I²S digital input, anti‑clipping function and comprehensive protection mechanisms make it widely used in consumer‑electronics audio products.
...
4. **Built‑in Digital High‑pass Filter**: Single‑pulse pin sets corner frequency for flexible adjustment.
...
2.  **Connect Hardware**: Select KS5033 preset. Connect the ESP32‑S3‑Mini kit to your PC with Type‑C cable.
